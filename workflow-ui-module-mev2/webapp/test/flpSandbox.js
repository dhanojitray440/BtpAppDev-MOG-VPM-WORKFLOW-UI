		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflowuimodulemev2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowuimodulemev2-display": {
								"semanticObject": "workflowuimodulemev2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowuimodulemev2",
									"url": sap.ui.require.toUrl("workflowuimodulemev2")
								}
							}
						}
					}
