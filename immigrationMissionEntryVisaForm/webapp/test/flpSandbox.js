		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#missionentryimmigrationMissionEntryVisaForm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"missionentryimmigrationMissionEntryVisaForm-display": {
								"semanticObject": "missionentryimmigrationMissionEntryVisaForm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mission.entry.immigrationMissionEntryVisaForm",
									"url": sap.ui.require.toUrl("mission/entry/immigrationMissionEntryVisaForm")
								}
							}
						}
					}
