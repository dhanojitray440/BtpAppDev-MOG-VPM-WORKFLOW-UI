		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflowuimodulemev-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowuimodulemev-display": {
								"semanticObject": "workflowuimodulemev",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowuimodulemev",
									"url": sap.ui.require.toUrl("workflowuimodulemev")
								}
							}
						}
					}
