		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflowuimodulemev3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowuimodulemev3-display": {
								"semanticObject": "workflowuimodulemev3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowuimodulemev3",
									"url": sap.ui.require.toUrl("workflowuimodulemev3")
								}
							}
						}
					}
