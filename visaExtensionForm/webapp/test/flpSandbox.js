		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#visaextensionvisaExtensionForm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"visaextensionvisaExtensionForm-display": {
								"semanticObject": "visaextensionvisaExtensionForm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=visaextension.visaExtensionForm",
									"url": sap.ui.require.toUrl("visaextension/visaExtensionForm")
								}
							}
						}
					}
